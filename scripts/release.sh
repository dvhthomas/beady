...
#
#     scripts/release.sh            # build/Beady-<version>.zip
...
ZIP="$ROOT/build/Beady-$VERSION.zip"
rm -f "$ZIP"
ditto -c -k --keepParent "$ROOT/build/Beady.app" "$ZIP"
echo "Wrote $ZIP"
echo
...
echo "  • run: xattr -dr com.apple.quarantine /Applications/Beady.app"
